...
public class DatabaseFactorySSS {
  ...
  private static DatabaseFactorySSS instance;
  ...
  public static DatabaseFactorySSS getInstance(Context context) {
    synchronized (lock) {
      if (instance == null)
        instance = new DatabaseFactorySSS(context);
  ...
  public static EncryptingPartDatabase getEncryptingPartDatabase(Context context, MasterSecret masterSecret) {
    synchronized (lock)  {
      if (encryptingPartInstance == null) {
        DatabaseFactorySSS factory = getInstance(context);
  ...
  private DatabaseFactorySSS(Context context) {
                                        ...
                                        DatabaseUpgradeActivity.DatabaseUpgradeListener listener)
  {
    ...
    DecryptingQueueSSS.schedulePendingDecrypts(context, masterSecret);
