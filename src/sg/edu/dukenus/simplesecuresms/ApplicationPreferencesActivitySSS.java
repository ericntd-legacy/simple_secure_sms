...
import org.thoughtcrime.securesms.PassphraseRequiredSherlockPreferenceActivity;
...
public class ApplicationPreferencesActivitySSS extends PassphraseRequiredSherlockPreferenceActivity
    implements SharedPreferences.OnSharedPreferenceChangeListener
{
  ...
  /*private class ChangePassphraseClickListener implements Preference.OnPreferenceClickListener {
    @Override
    public boolean onPreferenceClick(Preference preference) {
       if (MasterSecretUtil.isPassphraseInitialized(ApplicationPreferencesActivitySSS.this)) {
        startActivity(new Intent(ApplicationPreferencesActivitySSS.this, PassphraseChangeActivity.class));
      } else {
        Toast.makeText(ApplicationPreferencesActivitySSS.this,
  ...
  private class TrimNowClickListener implements Preference.OnPreferenceClickListener {
    @Override
    public boolean onPreferenceClick(Preference preference) {
      final int threadLengthLimit = Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(ApplicationPreferencesActivitySSS.this)
                                                                      .getString(THREAD_TRIM_LENGTH, "500"));

      AlertDialog.Builder builder = new AlertDialog.Builder(ApplicationPreferencesActivitySSS.this);
      ...
      builder.setPositiveButton(R.string.ApplicationPreferencesActivity_delete,
        ...
        public void onClick(DialogInterface dialog, int which) {
          Trimmer.trimAllThreads(ApplicationPreferencesActivitySSS.this, threadLengthLimit);
        }
      });
      ...
      if (!((CheckBoxPreference)preference).isChecked()) {
        ...
        builder.setPositiveButton(R.string.ApplicationPreferencesActivity_disable, new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialog, int which) {
            ...
            MasterSecretUtil.changeMasterSecretPassphrase(ApplicationPreferencesActivitySSS.this,
                                                          masterSecret,
                                                          MasterSecretUtil.UNENCRYPTED_PASSPHRASE);


            PreferenceManager.getDefaultSharedPreferences(ApplicationPreferencesActivitySSS.this)
                             .edit()
        ...
        //Intent intent = new Intent(ApplicationPreferencesActivitySSS.this,PassphraseChangeActivity.class);
