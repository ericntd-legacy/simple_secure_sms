...
public class ConversationItemSSS extends LinearLayout {
  ...
  public ConversationItemSSS(Context context) {
    super(context);
    this.context = context;
   }

  public ConversationItemSSS(Context context, AttributeSet attrs) {
    super(context, attrs);
    this.context = context;
  }
