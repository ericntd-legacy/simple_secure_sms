...
{
	// debugging
	private final String TAG = "ConversationActivitySSS";
  ...
  private void handleReturnToConversationList() {
    Intent intent = new Intent(this, ConversationListActivitySSS.class);
  ...
  private void handleAbortSecureSession() {
    ...
    builder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, int which) {
        if (isSingleConversation()) {
          KeyUtil.abortSessionFor(ConversationActivitySSS.this, getRecipients().getPrimaryRecipient());
          initializeSecurity();
          initializeTitleBar();
        }
      }
    ...
    if (threadId != -1) {
      new AsyncTask<Void, Void, Void>() {
        ...
        protected Void doInBackground(Void... params) {
          DatabaseFactory.getThreadDatabase(ConversationActivitySSS.this)
  ...
  private void handleDeleteThread() {
    ...
    builder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, int which) {
        if (threadId > 0) {
          DatabaseFactory.getThreadDatabase(ConversationActivitySSS.this).deleteConversation(threadId);
          finish();
        }
      }
    });
  ...
  private void initializeDraftFromDatabase() {
    new AsyncTask<Void, Void, List<Draft>>() {
      ...
      protected List<Draft> doInBackground(Void... params) {
        ...
        DraftDatabase draftDatabase = DatabaseFactory.getDraftDatabase(ConversationActivitySSS.this);
  ...
  private void initializeMmsEnabledCheck() {
    new AsyncTask<Void, Void, Boolean>() {
      ...
      protected Boolean doInBackground(Void... params) {
        return MmsSendHelper.hasNecessaryApnDetails(ConversationActivitySSS.this);
      }

      @Override
      protected void onPostExecute(Boolean isMmsEnabled) {
        ConversationActivitySSS.this.isMmsEnabled = isMmsEnabled;
      }
    }.execute();
  }
  ...
  private void initializeIme() {
    if (PreferenceManager.getDefaultSharedPreferences(this)
                         .getBoolean(ApplicationPreferencesActivitySSS.ENTER_PRESENT_PREF, false))
    {
  ...
  private void saveDraft() {
    ...
    new AsyncTask<Void, Void, Void>() {
      ...
      protected void onPreExecute() {
        Toast.makeText(ConversationActivitySSS.this,
      ...
      protected Void doInBackground(Void... params) {
        ...
        DatabaseFactory.getDraftDatabase(ConversationActivitySSS.this).insertDrafts(masterCipher, thisThreadId, drafts);
  ...
  private void markThreadAsRead() {
    new AsyncTask<Long, Void, Void>() {
      ...
      protected Void doInBackground(Long... params) {
        DatabaseFactory.getThreadDatabase(ConversationActivitySSS.this).setRead(params[0]);
        MessageNotifier.updateNotification(ConversationActivitySSS.this, masterSecret);
        return null;
      }
    }.execute(threadId);
  }
  ...
  private void sendComplete(Recipients recipients, long threadId) {
    ...
    if (this.recipientsPanel.getVisibility() == View.VISIBLE) {
      ConversationFragmentSSS fragment
        = (ConversationFragmentSSS)this.getSupportFragmentManager()
  ...
  /*private class AddRecipientButtonListener implements OnClickListener {
    ...
    public void onClick(View v) {
      Intent intent = new Intent(ConversationActivitySSS.this, ContactSelectionActivity.class);
    ...
    public boolean onKey(View v, int keyCode, KeyEvent event) {
      if (event.getAction() == KeyEvent.ACTION_DOWN) {
        if (keyCode == KeyEvent.KEYCODE_ENTER) {
          if (PreferenceManager.getDefaultSharedPreferences(ConversationActivitySSS.this)
                               .getBoolean(ApplicationPreferencesActivitySSS.ENTER_SENDS_PREF, false))
          {
