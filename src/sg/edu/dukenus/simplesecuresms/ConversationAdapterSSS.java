 ...
 *
 */
public class ConversationAdapterSSS extends CursorAdapter implements AbsListView.RecyclerListener {
  ...
  public ConversationAdapterSSS(Context context, MasterSecret masterSecret,
  ...
  public void bindView(View view, Context context, Cursor cursor) {
    ConversationItemSSS item       = (ConversationItemSSS)view;
  ...
  public void onMovedToScrapHeap(View view) {
    ((ConversationItemSSS)view).unbind();
  }
}
